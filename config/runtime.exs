...
if config_env() == :prod do
  ...
  # modal shows mqtts://MQTTS_HOST:MQTTS_PORT instead of the plain
  # MQTT_HOST:1883 — useful when brokers are exposed over the internet
  # through a TLS terminator. The broker itself stays plain TCP on
  # MQTT_BROKER_PORT inside the container.
