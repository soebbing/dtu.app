defmodule DtuAppWeb.UserAuth do
  ...
  @remember_me_cookie "_dtu_app_web_user_remember_me"
  @remember_me_options [
    sign: true,
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      DtuAppWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  @doc """
  Mounts the current scope for LiveView routes.
  """
